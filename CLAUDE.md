...
- **12.07.2026:** добавлены **российские источники** (Phase 3a, Tier 1 RSS) — см. секцию ниже.
...
- ⚠️ **Не проверено боем.** Локально хосты RU-фидов режет egress-политика песочницы (403 CONNECT), LLM-этапы локально не тестируются (ключи в Secrets). Валидность фидов и качество RU-текстов проверяются **боевым прогоном в Actions**.
